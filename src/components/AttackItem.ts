        ...
        >
          <div class="attack-header flex justify-between items-start mb-2">
            <input
              ...
              class="attack-name font-bold text-lg text-red-900 bg-transparent border-b-2 border-red-300 focus:border-red-500 flex-1"
              placeholder="Attack Name"
              data-testid="edit-attack-name"
            />
            <div class="attack-badges flex gap-2 ml-2">
              <input
                type="number"
                ...
                class="attack-badge attack-damage px-2 py-1 bg-amber-100 border border-amber-300 rounded text-xs font-semibold text-amber-900 w-16"
                placeholder="Damage"
              ...
              <input
                ...
                class="attack-badge attack-modifier px-2 py-1 bg-blue-100 border border-blue-300 rounded text-xs font-semibold text-blue-900 w-16"
                placeholder="Mod"
          ...
          <div class="attack-info mb-2">
            <input
              ...
              class="attack-range text-xs text-red-700 font-semibold bg-transparent border-b-2 border-red-300 focus:border-red-500 w-full"
              placeholder="Range"
          ...
          <textarea
            ...
            class="attack-notes text-gray-700 text-sm leading-relaxed w-full bg-transparent border-b-2 border-red-300 focus:border-red-500"
            placeholder="Notes"
            rows="2"
